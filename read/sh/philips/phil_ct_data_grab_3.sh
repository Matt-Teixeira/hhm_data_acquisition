...
if [ $? -eq 0 ]; then
    ...
    timeout 60 sshpass -p $3 scp -o StrictHostKeyChecking=accept-new $2@$1:/cygdrive/d/Data_Logger/Logger.mdb /home/matt-teixeira/hep3/hhm_data_acquisition/test_hhm/Philips/CT/$4

...
if [ $? -eq 0 ]; then
    ...
    timeout 60 lftp sftp://$2:$3@$1 -e "set xfer:clobber on; cd /cygdrive/d/Data_Logger/;lcd /home/matt-teixeira/hep3/hhm_data_acquisition/test_hhm/Philips/CT/$4/; get Output.mdb; exit"

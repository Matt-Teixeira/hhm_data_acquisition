...
if [ $? -eq 0 ]; then
    ...
    timeout 3 sshpass -p $3 scp -o StrictHostKeyChecking=accept-new -oKexAlgorithms=diffie-hellman-group1-sha1,diffie-hellman-group-exchange-sha256,diffie-hellman-group14-sha1 $2@$1:/c/Program\ Files/GE\ Medical\ Systems/DL/Log/sys* /home/matt-teixeira/hep3/hhm_data_acquisition/test_hhm/GE/CV/$4

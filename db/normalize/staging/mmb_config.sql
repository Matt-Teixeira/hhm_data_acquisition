...
{ "ssh": { "host": "SME17381",
"user_id": "avante",
"ip_address": "10.75.0.60" },
"rpp_configs": [{"pgTable": "mmb_ge_mm3", "schedule": 1, "mmbScript": "v3_ge_mm3", "regexModels": ["RE_GE_MM3_A"] },
{ "pgTable": "mmb_edu2",
"schedule": 7,
"mmbScript": "v2_edu2",
"regexModels": ["RE_EDU2_COMP_VIB", "RE_EDU2_ROOM_PROBE_HUM_TEMP", "RE_EDU2_TEMP_PROBE_TEMPS"] } ] }
INSERT INTO
	config.mag (
		system_id,
		file_name,
